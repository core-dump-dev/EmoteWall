...
window.EmoteWallConfig = {
  ...
  testMode: false,                         // Включить автоматический тестовый режим
  testInterval: 5000,                      // Интервал теста в миллисекундах (5 секунд)
  ...
  // === Внешний вид ===
  emoteScale: 1.0,                         // Базовый масштаб эмодзи (0.1 - 5.0)
  emoteMinScale: 0.5,                      // Минимальный случайный масштаб
  emoteMaxScale: 2.0,                      // Максимальный случайный масштаб
